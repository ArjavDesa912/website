              ...
              <div className="relative">
                ...
                <div className="relative group">
                  ...
                  <img 
                    ...
                    className="relative rounded-3xl shadow-2xl border border-white/20 transform group-hover:scale-105 transition-transform duration-500"
                  />
                  
                  {/* Floating Stats Cards */}
                  <div className="absolute -top-4 -left-4 bg-slate-900/70 backdrop-blur-md rounded-2xl p-4 shadow-xl border border-white/20">
                  ...
                  <div className="absolute -bottom-4 -right-4 bg-slate-900/70 backdrop-blur-md rounded-2xl p-4 shadow-xl border border-white/20">
                    <div className="flex items-center gap-3">
                      <div className="w-3 h-3 bg-blue-500 rounded-full animate-pulse"></div>
                      <div>
                        <p className="text-sm font-medium text-slate-200">AI Models</p>
